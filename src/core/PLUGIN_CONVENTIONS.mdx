---
id: kibCorePluginArch
slug: /kibana-team/core-plugin-arch
title: Building a Kibana plugin
summary: How to use core services for building a Kibana plugin
date: 2020-12-22
...
If building a plugin inside the Kibana repo, it should go inside `src/plugins` or `x-pack/plugins` depending
on the license level. If building a plugin externally, it should be located inside the top level `plugins`
directory.
