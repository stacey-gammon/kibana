...
export class ExpandPanelAction extends Action {
  ...
  public getTitle({
    embeddable,
    container,
  }: PanelActionAPI<Embeddable, DashboardContainer>) {
  ...
  public isCompatible({
    ...
    return Promise.resolve(container && container.type === DASHBOARD_CONTAINER_TYPE && embeddable && embeddable.getInput().viewMode === ViewMode.VIEW);
  }
